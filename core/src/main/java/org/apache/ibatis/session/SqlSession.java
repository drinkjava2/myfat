...
public interface SqlSession extends Closeable {
  ...
  Connection getConnection();
	...
	/**
	 * Return a new SqlBoxContext based on current SqlSession's dataSource, and mark sqlsession
	...
	public default SqlBoxContext ctx() { 	  
		if (this instanceof DefaultSqlSession) { 
			...
			if (f == null)
				throw new SqlBoxException("Can not access SqlSession, target:" +this.getClass());
