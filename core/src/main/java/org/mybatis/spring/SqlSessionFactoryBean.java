...
/**
 * {@code FactoryBean} that creates a MyBatis {@code SqlSessionFactory}. This is
 * the usual way to set up a shared MyBatis {@code SqlSessionFactory} in a
...
public class SqlSessionFactoryBean
	 ...
	 *
	 * <p>
	 * Since 2.0.1, allow to specify a wildcard such as
	 * {@code com.example.*.typehandler}.
	 * 
	 * @since 1.0.1
	 *
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
		...
		if (this.mapperLocations != null) {
		 ...
		 //Modified by YZ
		configuration.addInterceptor(Helper.instance);
